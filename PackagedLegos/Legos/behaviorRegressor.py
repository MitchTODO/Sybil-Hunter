...
#/Users/mitch/Downloads/Legos/Legos/
model = ct.models.MLModel("/Users/mitch/Desktop/Legos/PackagedLegos/Legos/models/BehaviorRegressor.mlmodel")

'''
Behavior Regressor Lego

Discription: Regression through address behavior

Input : Ethereum Address
Output : Int (raw boolean representation 1 || 0 ) 

Note: Script structure similar to AssociationClassifier.py
...
Example:
    ...
    IN:
        python3 behaviorRegressor.py 0x94ea89d08e840fe58053bf7f059b46b6f03bdc96
    OUT:
        0 
...
def main():
    ...
    # get request for transactions from trueblocks
    ...
    # sybil and nonSybil counter for each tx   
    sybil = 0
    nonSybil = 0
    ...
    for consolidedTx in op_data:
        ...
        # note address accociatied is not included with behavior regressor model
